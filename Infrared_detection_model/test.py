...
parser.add_argument("--model_names", default=['SCTrans'], type=list,
                    help="model_name: 'ACM', 'Ours01', 'DNANet', 'ISNet', 'ACMNet', 'Ours01', 'ISTDU-Net', 'U-Net', 'RISTDnet'")
parser.add_argument("--pth_dirs", default=['/monochale/SCTransNet_585_best.pth.tar'], type=list)
# 将路径中的反斜杠替换为正斜杠
parser.add_argument("--dataset_dir", default='/home/gdut_students/lyh/SCTransNet-main7/datasets', type=str, help="train_dataset_dir")
parser.add_argument("--dataset_names", default=['monochale'], type=list,
                    help="dataset_name: 'NUAA-SIRST', 'NUDT-SIRST', 'IRSTD-1K', 'SIRST3', 'NUDT-SIRST-Sea'")
parser.add_argument("--img_norm_cfg", default=None, type=dict,
                    help="specific a img_norm_cfg, default=None (using img_norm_cfg values of each dataset)")
parser.add_argument("--save_img", default=True, type=bool, help="save image of or not")
# 修正保存图片和日志的路径
parser.add_argument("--save_img_dir", type=str, default='/home/gdut_students/lyh/SCTransNet-main7/otherlog/',
                    help="path of saved image")
parser.add_argument("--save_log", type=str, default='/home/gdut_students/lyh/SCTransNet-main7/log', help="path of saved .pth")
parser.add_argument("--threshold", type=float, default=0.5)
global opt
opt = parser.parse_args()
...
def test():
    test_set = TestSetLoader(opt.dataset_dir, 'monochale', 'monochale', opt.img_norm_cfg)
    ...
    with torch.no_grad():
        ...
        print('pixAcc: %.4f| mIoU: %.4f | nIoU: %.4f | Pd: %.4f| Fa: %.4f |F1: %.4f | Inference Time: %.4fs'
              % (pixAcc * 100, mIOU * 100, nIoU * 100, results2[0] * 100, results2[1] * 1e+6, F1_score * 100, avg_inference_time))
